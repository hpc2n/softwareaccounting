...
An list of regexp rules that are matched into an software definition.
...
all rules will be applied after each match i the order of appearance in the config file.
